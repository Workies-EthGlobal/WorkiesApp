...
abstract contract PaymentManager is SuperAppBase {
    ...
    modifier addEmployee(address wallet, int96 daily_payment)  {
        _; 
    ...
    function afterAgreementTerminated(
        ...
        bytes calldata, // _cbdata,
        bytes calldata ctx
    ) external override view onlyHost returns (bytes memory newCtx) {
